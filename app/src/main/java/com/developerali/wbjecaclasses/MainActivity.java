...
import com.developerali.wbjecaclasses.Activities.MyBooks;
import com.developerali.wbjecaclasses.Activities.NotificationActivity;
import com.developerali.wbjecaclasses.Activities.ProfileActivity;
import com.developerali.wbjecaclasses.Adapters.BooksAdapter;
import com.developerali.wbjecaclasses.Adapters.ToolsAdapter;
import com.developerali.wbjecaclasses.Models.BannerModel;
...
import com.developerali.wbjecaclasses.Notification.FcmNotificationsSender;
import com.developerali.wbjecaclasses.databinding.ActivityMainBinding;
import com.developerali.wbjecaclasses.databinding.BottomListsBinding;
import com.developerali.wbjecaclasses.databinding.CustomDialogBinding;
import com.developerali.wbjecaclasses.databinding.DialogNotLoginBinding;
import com.developerali.wbjecaclasses.databinding.DialogUpdateLayoutBinding;
...
//        arrayList.add(new ToolsModel("Options", getDrawable(R.drawable.menubar)));
        arrayList.add(new ToolsModel("Computer Intro.", getDrawable(R.drawable.comp_intro)));
        arrayList.add(new ToolsModel("C Programing", getDrawable(R.drawable.c_programming)));
        arrayList.add(new ToolsModel("Computer Network", getDrawable(R.drawable.comp_network)));
        arrayList.add(new ToolsModel("Data Structure", getDrawable(R.drawable.data_structure)));
        arrayList.add(new ToolsModel("Operating System", getDrawable(R.drawable.operating_system)));
        arrayList.add(new ToolsModel("Software Engineering", getDrawable(R.drawable.software_eng)));
        arrayList.add(new ToolsModel("OOPS", getDrawable(R.drawable.oops)));
        arrayList.add(new ToolsModel("Unix", getDrawable(R.drawable.unix)));
        arrayList.add(new ToolsModel("DBMS", getDrawable(R.drawable.dbms)));

        arrayList.add(new ToolsModel("Machine Learning", getDrawable(R.drawable.ml)));

        GridLayoutManager gnm = new GridLayoutManager(MainActivity.this, 2);
        binding.rec.setLayoutManager(gnm);
        ToolsAdapter toolsAdapter = new ToolsAdapter(MainActivity.this, arrayList);
        binding.rec.setAdapter(toolsAdapter);
...
//        });
        ...
        data.getReference().child("homeBanners")
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                                ...
                                for (BannerModel bannerModel : links) {
                                    ...
                                    if (!MainActivity.this.isDestroyed()){
                                        Glide.with(MainActivity.this)
                                                ...
                                                .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
                                                .placeholder(R.drawable.book_placeholder) // Optional placeholder
                                                .into(imageView);
                                    }
...
//                });
    ...
    private void showBannerDialog(String message, String link) {
        DialogNotLoginBinding dialogBinding = DialogNotLoginBinding.inflate(LayoutInflater.from(MainActivity.this));
