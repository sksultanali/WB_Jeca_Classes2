...
import com.developerali.wbjecaclasses.Models.QuestionModel;
import com.developerali.wbjecaclasses.R;
import com.developerali.wbjecaclasses.databinding.ActivityPlayQuizBinding;
...
//        String url = apiKey + "action=read";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i<jsonArray.length(); i++){
                        ...
                        String explain = object.getString("explanation");
                        String answer = object.getString("answer");

                        QuestionModel questionModel = new QuestionModel(question, optionA, optionB, optionC, optionD, answer);
                        questionModel.setExplanation(explain);
    ...
    void showAnswer() {
        ...
        binding.explain.setText(question.getExplanation());
        try {
